...
public class ShapesDimensionalContactPairCacheProvider implements ContactPairCacheProvider {
    ...
    public ShapesDimensionalContactPairCacheProvider(Supplier<RigidBodyIsland> rigidBodyIsland, PairGenerator pairGenerator, OneDimensionProvider oneDimensionProvider) {
    ...
    public ContactPairCache newFilledCache() {
        ...
        Collection<PreCollisionShape> collisionShapes = new ArrayList<>();
